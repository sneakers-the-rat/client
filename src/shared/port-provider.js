 ...
 *    frame can be the host, in others it is an iframe from where either (1)
 *    the hypothesis client has been injected or (2) the hypothesis client has
 *    been configured to act exclusively as a guest (not showing the sidebar).
 ...
 *                 |
 *                 V
 * 5. send reciprocal port to the `sidebar` frame using the
 *    `host-sidebar(MessageChannel).sidebar(MessagePort)`
 *
 *
